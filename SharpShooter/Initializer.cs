...
namespace SharpShooter
{
    internal class Initializer
    {
        internal static void Initialize()
        {
            ...
            {
                Game.PrintChat("Your license to use SharpShooter has expired. you can buy a license to use SharpShooter for 1 month for $200, 6 months for only $1000. if you want to renew your license, contact xcsoft");
                Utility.DelayAction.Add(10000, Load);
                Utility.DelayAction.Add(11000, () => Game.PrintChat("it was a joke. sorry."));
                return;
            }
